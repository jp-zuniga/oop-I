...
In DemoFacultad-labels_en.properties:
DemoFacultad=My application
DemoFacultad[description]=My application does this and that

In DemoFacultad-messages_en.properties:
